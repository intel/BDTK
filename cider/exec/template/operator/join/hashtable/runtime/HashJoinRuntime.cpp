...
#include <future>
#include <numeric>
#include "exec/template/CompareKeysInl.h"
...
void SUFFIX(init_hash_join_buff)(int32_t* groups_buffer,
...
auto fill_hash_join_buff_impl(int32_t* buff,
                              const int32_t invalid_slot_val,
...
int SUFFIX(fill_hash_join_buff_bucketized)(int32_t* buff,
                                           const int32_t invalid_slot_val,
...
int SUFFIX(fill_hash_join_buff)(int32_t* buff,
                                const int32_t invalid_slot_val,
                                const bool for_semi_join,
                                const JoinColumn join_column,
                                const JoinColumnTypeInfo type_info,
...
template <typename T>
void SUFFIX(init_baseline_hash_join_buff)(int8_t* hash_buff,
...
template <typename T>
int write_baseline_hash_slot(const int32_t val,
                             int8_t* hash_buff,
                             const int64_t entry_count,
                             const T* key,
                             const size_t key_component_count,
...
template <typename T>
int write_baseline_hash_slot_for_semi_join(const int32_t val,
                                           int8_t* hash_buff,
                                           const int64_t entry_count,
                                           const T* key,
                                           const size_t key_component_count,
...
int SUFFIX(fill_baseline_hash_join_buff)(int8_t* hash_buff,
                                         const int64_t entry_count,
                                         const int32_t invalid_slot_val,
                                         const bool for_semi_join,
                                         const size_t key_component_count,
...
void count_matches_impl(int32_t* count_buff,
                        const int32_t invalid_slot_val,
                        const JoinColumn join_column,
                        const JoinColumnTypeInfo type_info,
                        const void* sd_inner_proxy,
...
void SUFFIX(count_matches)(int32_t* count_buff,
                           const int32_t invalid_slot_val,
                           const JoinColumn join_column,
                           const JoinColumnTypeInfo type_info,
                           const void* sd_inner_proxy,
...
void SUFFIX(count_matches_bucketized)(int32_t* count_buff,
                                      const int32_t invalid_slot_val,
                                      const JoinColumn join_column,
                                      const JoinColumnTypeInfo type_info,
                                      const void* sd_inner_proxy,
...
template <typename T>
NEVER_INLINE const T* SUFFIX(get_matching_baseline_hash_slot_readonly)(
    const T* key,
    const size_t key_component_count,
...
void SUFFIX(count_matches_baseline)(int32_t* count_buff,
                                    const T* composite_key_dict,
                                    const int64_t entry_count,
                                    const KEY_HANDLER* f,
                                    const int64_t num_elems,
...
template <typename SLOT_SELECTOR>
void fill_row_ids_impl(int32_t* buff,
                       const int64_t hash_entry_count,
                       const int32_t invalid_slot_val,
                       const JoinColumn join_column,
                       const JoinColumnTypeInfo type_info,
...
void SUFFIX(fill_row_ids)(int32_t* buff,
                          const int64_t hash_entry_count,
                          const int32_t invalid_slot_val,
                          const JoinColumn join_column,
                          const JoinColumnTypeInfo type_info,
...
void SUFFIX(fill_row_ids_bucketized)(int32_t* buff,
                                     const int64_t hash_entry_count,
                                     const int32_t invalid_slot_val,
                                     const JoinColumn join_column,
                                     const JoinColumnTypeInfo type_info,
...
template <typename T, typename KEY_HANDLER>
void SUFFIX(fill_row_ids_baseline)(int32_t* buff,
                                   const T* composite_key_dict,
                                   const int64_t hash_entry_count,
                                   const int32_t invalid_slot_val,
                                   const KEY_HANDLER* f,
...
void SUFFIX(approximate_distinct_tuples_impl)(uint8_t* hll_buffer,
...
template <size_t N>
void SUFFIX(compute_bucket_sizes_impl)(double* bucket_sizes_for_thread,
                                       const JoinColumn* join_column,
                                       const JoinColumnTypeInfo* type_info,
