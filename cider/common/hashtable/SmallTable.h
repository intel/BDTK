...
class SmallTable : private boost::noncopyable, protected Cell::State {
 protected:
  ...
  /// and then by the collision resolution chain.
  ...
  class const_iterator  /// NOLINT
  {
   ...
   public:
    ...
    const_iterator(const Self* container_, const Cell* ptr_)
        : container(container_), ptr(ptr_) {}  /// NOLINT
    const_iterator(const iterator& rhs)
        : container(rhs.container), ptr(rhs.ptr) {}  /// NOLINT
 ...
 public:
  ...
  /// Insert the value. In the case of any more complex values, it is better to use the
  /// `emplace` function.
