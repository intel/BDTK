...
struct FixedClearableHashMapCell {
  ...
  FixedClearableHashMapCell(const value_type& value_, const State& state)
      : version(state.version), mapped(value_.second) {}
...
class FixedClearableHashMap : public FixedHashMap<Key,
                                                  Mapped,
                                                  FixedClearableHashMapCell<Key, Mapped>,
                                                  Allocator> {
 public:
  using Base =
      FixedHashMap<Key, Mapped, FixedClearableHashMapCell<Key, Mapped>, Allocator>;
