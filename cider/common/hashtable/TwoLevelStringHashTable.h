...
template <typename SubMaps,
          typename ImplTable = StringHashTable<SubMaps>,
...
class TwoLevelStringHashTable : private boost::noncopyable {
 ...
 public:
  ...
  // TODO: currently hashing contains redundant computations when doing distributed or
  // external aggregations
  size_t hash(const Key& x) const {
    return const_cast<Self&>(*this).dispatch(
        *this, x, [&](const auto&, const auto&, size_t hash) { return hash; });
  }
