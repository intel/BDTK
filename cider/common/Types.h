...
/// Hold a null value for untyped calculation. It can also store infinities to handle
/// nullable comparison which is used for nullable KeyCondition.
struct Null {
  enum class Value {
    Null,
    PositiveInfinity,
...
/// @note Except explicitly described you should not assume on TypeIndex numbers and/or
/// their orders in this enum.
