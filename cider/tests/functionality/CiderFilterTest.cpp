...
TEST_F(CiderFilterSequenceTestArrow, ArrowInTest) {
  ...
  prepareArrowBatch();
  assertQueryArrow("SELECT * FROM test WHERE col_1 in (24, 25, 26)", "in_int32_array.json");
  assertQueryArrow("SELECT * FROM test WHERE col_2 in (24, 25, 26)", "in_int64_array.json");
  assertQueryArrow("SELECT * FROM test WHERE col_3 in (24, 25, 26)", "in_fp32_array.json");
  assertQueryArrow("SELECT * FROM test WHERE col_4 in (24, 25, 26)", "in_fp64_array.json");
