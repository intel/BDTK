...
class PrestoFunctionLookUpContext : public BasicFunctionLookUpContext {
 public:
  virtual ~PrestoFunctionLookUpContext(){};
...
using PrestoFunctionLookUpContextPtr = std::shared_ptr<PrestoFunctionLookUpContext>;

namespace YAML {

template <>
struct convert<PrestoFunctionLookUpContext> {
  static bool decode(const Node& node, PrestoFunctionLookUpContext& extension) {
