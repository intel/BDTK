...
EXTENSION_NOINLINE
bool Between(const double x, const double low, const double high) {
#ifdef ENABLE_VELOX_FUNCTION
  facebook::velox::functions::BetweenFunction<double> instance;
  bool r = false;
  instance.call(r, x, low, high);
  return r;
#else
  return x >= low && x <= high;
#endif
...
EXTENSION_NOINLINE
bool Between__3(const int64_t x, const int64_t low, const int64_t high) {
#ifdef ENABLE_VELOX_FUNCTION
  facebook::velox::functions::BetweenFunction<int64_t> instance;
  bool r = false;
  instance.call(r, x, low, high);
  return r;
#else
...
#ifdef ENABLE_VELOX_FUNCTION
  facebook::velox::functions::RoundFunction<double> instance;
  double r = 0.0;
  instance.call(r, x, y);
  return r;
#else
...
#ifdef ENABLE_VELOX_FUNCTION
  facebook::velox::functions::RoundFunction<float> instance;
  float r = 0.0;
  instance.call(r, x, y);
  return r;
#else
...
#ifdef ENABLE_VELOX_FUNCTION
  facebook::velox::functions::RoundFunction<int16_t> instance;
  int16_t r = 0;
  instance.call(r, x, y);
  return r;
#else
...
#ifdef ENABLE_VELOX_FUNCTION
  facebook::velox::functions::RoundFunction<int32_t> instance;
  int32_t r = 0;
  instance.call(r, x, y);
  return r;
#else
...
#ifdef ENABLE_VELOX_FUNCTION
  facebook::velox::functions::RoundFunction<int64_t> instance;
  int64_t r = 0;
  instance.call(r, x, y);
  return r;
#else
...
double Cbrt(const double x) {
  facebook::velox::functions::CbrtFunction<double> instance;
  double r = 0.0;
  instance.call(r, x);
  return r;
}
