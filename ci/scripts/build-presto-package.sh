...
cp -a /usr/local/lib/libhdfs3.so* ./${package_name}/lib
cp -a /usr/lib/x86_64-linux-gnu/libgsasl.so* ./${package_name}/lib
cp -a /usr/lib/x86_64-linux-gnu/libntlm.so* ./${package_name}/lib
