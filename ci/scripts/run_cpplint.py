...
# This file is copied from Apache Arrow code base.
...
if __name__ == "__main__":
    ...
    if not arguments.source_dir:
        print("No source file, Exiting", file=sys.stderr)

    with open(arguments.source_dir) as f:
        for line in f:
            pathes = lintutils.get_sources(line.strip(), exclude_globs)
            for path in pathes:
