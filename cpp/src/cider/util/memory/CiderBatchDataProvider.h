...
#ifndef CIDER_CIDERBATCHDATAPROVIDER_H
#define CIDER_CIDERBATCHDATAPROVIDER_H
...
class CiderBatchDataProvider : public DataProvider {
 public:
  explicit CiderBatchDataProvider(const CiderBatch& ciderBatch)
...
#endif  // CIDER_CIDERBATCHDATAPROVIDER_H
