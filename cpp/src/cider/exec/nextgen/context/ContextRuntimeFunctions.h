...
extern "C" RUNTIME_FUNC ALLOW_INLINE int8_t* get_query_context_item_ptr(int8_t* context, size_t id) {
  auto context_ptr =
...
extern "C" RUNTIME_FUNC ALLOW_INLINE int8_t* get_query_context_string_heap_ptr(int8_t* context) {
  auto context_ptr =
      reinterpret_cast<cider::exec::nextgen::context::RuntimeContext*>(context);
...
extern "C" RUNTIME_FUNC ALLOW_INLINE int8_t* get_query_context_trim_char_map_by_id(int8_t* context,
                                                                       int id) {
  auto context_ptr =
      reinterpret_cast<cider::exec::nextgen::context::RuntimeContext*>(context);
...
extern "C" RUNTIME_FUNC ALLOW_INLINE void* extract_arrow_array_buffer(int8_t* arrow_pointer,
                                                          int64_t index) {
  ArrowArray* array = reinterpret_cast<ArrowArray*>(arrow_pointer);
  return const_cast<void*>(array->buffers[index]);
}

extern "C" RUNTIME_FUNC ALLOW_INLINE void* extract_arrow_array_child(int8_t* arrow_pointer,
                                                         int64_t index) {
  ArrowArray* array = reinterpret_cast<ArrowArray*>(arrow_pointer);
  return reinterpret_cast<void*>(array->children[index]);
}

extern "C" RUNTIME_FUNC ALLOW_INLINE int8_t* extract_arrow_array_dictionary(int8_t* arrow_pointer) {
  ArrowArray* array = reinterpret_cast<ArrowArray*>(arrow_pointer);
  return reinterpret_cast<int8_t*>(array->dictionary);
}

extern "C" RUNTIME_FUNC ALLOW_INLINE int64_t extract_arrow_array_len(int8_t* arrow_pointer) {
  ArrowArray* array = reinterpret_cast<ArrowArray*>(arrow_pointer);
  return array->length;
}

extern "C" RUNTIME_FUNC ALLOW_INLINE void set_arrow_array_len(int8_t* arrow_pointer, int64_t len) {
  ArrowArray* array = reinterpret_cast<ArrowArray*>(arrow_pointer);
  array->length = len;
}

extern "C" RUNTIME_FUNC ALLOW_INLINE void allocate_arrow_array_buffer(int8_t* array,
