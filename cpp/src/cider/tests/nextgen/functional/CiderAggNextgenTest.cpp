...
class CiderAggArrowTest : public CiderNextgenTestBase {
 public:
  CiderAggArrowTest() {
    table_name_ = "test";
    create_ddl_ =
...
TEST_F(CiderAggArrowTest, countTest) {
  ...
  //       "SELECT half_null_fp32, COUNT(1) FROM test GROUP BY half_null_fp32");
  //   assertQueryArrowIgnoreOrder(
  //       "SELECT half_null_fp64, COUNT(half_null_fp64) FROM test GROUP BY
  //       half_null_fp64");
  ...
  assertQuery("SELECT COUNT(all_null_i32) FROM test");
  assertQuery("SELECT COUNT(all_null_i32) FROM test WHERE all_null_i32 IS NOT NULL");
  assertQuery("SELECT COUNT(all_null_i32) FROM test WHERE all_null_i32 IS NULL");
  // COUNT(BIGINT) with all null
  assertQuery("SELECT COUNT(all_null_i64) FROM test");
  assertQuery("SELECT COUNT(all_null_i64) FROM test WHERE all_null_i64 IS NOT NULL");
  assertQuery("SELECT COUNT(all_null_i64) FROM test WHERE all_null_i64 IS NULL");
  // COUNT(FLOAT) with all null
  assertQuery("SELECT COUNT(all_null_fp32) FROM test");
  assertQuery("SELECT COUNT(all_null_fp32) FROM test WHERE all_null_fp32 IS NOT NULL");
  assertQuery("SELECT COUNT(all_null_fp32) FROM test WHERE all_null_fp32 IS NULL");
  // COUNT(DOUBLE) with all null
  assertQuery("SELECT COUNT(all_null_fp64) FROM test");
  assertQuery("SELECT COUNT(all_null_fp64) FROM test WHERE all_null_fp64 IS NOT NULL");
  assertQuery("SELECT COUNT(all_null_fp64) FROM test WHERE all_null_fp64 IS NULL");
  // COUNT(SMALLINT) with all null
  assertQuery("SELECT COUNT(all_null_i16) FROM test");
  assertQuery("SELECT COUNT(all_null_i16) FROM test WHERE all_null_i16 IS NOT NULL");
  assertQuery("SELECT COUNT(all_null_i16) FROM test WHERE all_null_i16 IS NULL");
  // COUNT(TINYINT) with all null
  assertQuery("SELECT COUNT(all_null_i8) FROM test");
  assertQuery("SELECT COUNT(all_null_i8) FROM test WHERE all_null_i8 IS NOT NULL");
  assertQuery("SELECT COUNT(all_null_i8) FROM test WHERE all_null_i8 IS NULL");
...
class CiderPartialAVGIntegerTest : public CiderNextgenTestBase {
 public:
...
TEST_F(CiderPartialAVGIntegerTest, singlePartialAVG) {
  ...
  assertQuery(
      "avg_partial.json", std::get<1>(schema_and_array), std::get<0>(schema_and_array));
}
...
TEST_F(CiderPartialAVGIntegerTest, withNullPartialAVG) {
  ...
  assertQuery("avg_with_null_partial.json",
...
TEST_F(CiderPartialAVGIntegerTest, allNullPartialAVG) {
  ...
  // select avg(col_i32_all_null) from test
  assertQuery("avg_all_null_partial.json",
              std::get<1>(schema_and_array),
              std::get<0>(schema_and_array));
}
...
TEST_F(CiderPartialAVGIntegerTest, mixedPartialAVG) {
  ...
  // select avg(col_i32), sum(col_i16), avg(col_i32) from test
  assertQuery("multi_integer_avg_partial.json",
              std::get<1>(schema_and_array),
              std::get<0>(schema_and_array));
}

class CiderPartialAVGFpArrowTest : public CiderNextgenTestBase {
 public:
...
TEST_F(CiderPartialAVGFpArrowTest, mixedPartialAVG) {
  ...
  assertQuery("multi_fp_avg_partial.json",
              std::get<1>(schema_and_array),
              std::get<0>(schema_and_array));
...
TEST_F(CiderPartialAVGFpArrowTest, mixedGroupbyPartialAVG) {
  ...
  assertQuery("multi_fp_groupby_avg_partial.json",
              std::get<1>(schema_and_array),
              std::get<0>(schema_and_array),
              true);
  delete[] expect_arrays;
