...
extern "C" RUNTIME_FUNC ALLOW_INLINE int32_t external_call_test_sum(int32_t a, int32_t b) {
  return a + b;
}
...
extern "C" RUNTIME_FUNC ALLOW_INLINE int64_t decimal_floor(const int64_t x, const int64_t scale) {
  if (x >= 0) {
...
extern "C" RUNTIME_FUNC ALLOW_INLINE int64_t decimal_ceil(const int64_t x, const int64_t scale) {
...
extern "C" RUNTIME_FUNC ALLOW_INLINE int get_str_length_from_dictionary(int8_t* dictionary,
                                                            uint64_t index) {
...
extern "C" RUNTIME_FUNC ALLOW_INLINE const int8_t* get_str_ptr_from_dictionary(int8_t* dictionary,
                                                                   uint64_t index) {
  const int32_t* offset_buffer = reinterpret_cast<const int32_t*>(
      reinterpret_cast<ArrowArray*>(dictionary)->buffers[1]);
...
extern "C" RUNTIME_FUNC ALLOW_INLINE bool check_bit_vector_set(uint8_t* bit_vector, uint64_t index) {
...
extern "C" RUNTIME_FUNC ALLOW_INLINE void set_bit_vector(uint8_t* bit_vector, uint64_t index) {
  CiderBitUtils::setBitAt(bit_vector, index);
}

extern "C" RUNTIME_FUNC ALLOW_INLINE void clear_bit_vector(uint8_t* bit_vector, uint64_t index) {
...
extern "C" RUNTIME_FUNC ALLOW_INLINE void do_memcpy(int8_t* dst, int8_t* src, int32_t len) {
  memcpy(dst, src, len);
}
