...
class FilterProjectDeleteTest : public PlanTransformerTestBase {
 public:
  FilterProjectDeleteTest() {
    auto transformerFactory = PlanTransformerFactory().registerPattern(
        std::make_shared<ProjectFilterPattern>(),
        std::make_shared<ProjcetFilterDeleteRewriter>());
    setTransformerFactory(transformerFactory);
  }
};

TEST_F(FilterProjectDeleteTest, noNeedToDelete) {
...
TEST_F(FilterProjectDeleteTest, singelBranchDelete) {
  VeloxPlanBuilder transformPlanBuilder;
...
TEST_F(FilterProjectDeleteTest, singelBranchDelete2) {
  VeloxPlanBuilder transformPlanBuilder;
  VeloxPlanNodePtr planPtr =
...
TEST_F(FilterProjectDeleteTest, MultiBranchesDelete) {
