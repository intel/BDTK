...
template <typename T>
T CiderOperatorTestBase::gen_value(std::mt19937& gen) {
  UNREACHABLE();
}

template <>
bool CiderOperatorTestBase::gen_value<bool>(std::mt19937& gen) {
  return folly::Random::rand32(0, 2, gen) == 0;
}

template <>
int8_t CiderOperatorTestBase::gen_value<int8_t>(std::mt19937& gen) {
  return static_cast<int8_t>(folly::Random::rand32(gen));
}

template <>
int16_t CiderOperatorTestBase::gen_value<int16_t>(std::mt19937& gen) {
  return static_cast<int16_t>(folly::Random::rand32(gen));
}

template <>
int32_t CiderOperatorTestBase::gen_value<int32_t>(std::mt19937& gen) {
  return static_cast<int32_t>(folly::Random::rand32(gen));
}

template <>
int64_t CiderOperatorTestBase::gen_value<int64_t>(std::mt19937& gen) {
  return folly::Random::rand64(gen);
}

template <>
float CiderOperatorTestBase::gen_value<float>(std::mt19937& gen) {
  return static_cast<float>(folly::Random::randDouble01(gen));
}

template <>
double CiderOperatorTestBase::gen_value<double>(std::mt19937& gen) {
  return folly::Random::randDouble01(gen);
}

template <>
Date CiderOperatorTestBase::gen_value<Date>(std::mt19937& gen) {
  return Date(folly::Random::rand32(gen));
}

template <>
Timestamp CiderOperatorTestBase::gen_value<Timestamp>(std::mt19937& gen) {
...
template <>
IntervalDayTime CiderOperatorTestBase::gen_value<IntervalDayTime>(std::mt19937& gen) {
  return IntervalDayTime(folly::Random::rand32(gen));
}

template <>
StringView CiderOperatorTestBase::gen_value<StringView>(std::mt19937& gen) {
  char buff[12] = {'\0'};
