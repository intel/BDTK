...
-- SELECT * from cider_hash_join_table_probe LEFT JOIN cider_hash_join_table_hash ON l_a = r_a OR l_d = r_d ;
SELECT * from cider_hash_join_table_probe JOIN cider_hash_join_table_hash ON l_b = r_b OR l_b = 10 ;
-- SELECT * from cider_hash_join_table_probe LEFT JOIN cider_hash_join_table_hash ON l_a = r_a OR l_a = 10 ;
...
-- SELECT SUM(l_a) from cider_hash_join_table_probe LEFT JOIN cider_hash_join_table_hash ON l_a = r_a OR l_d = r_d ;
SELECT SUM(l_a) from cider_hash_join_table_probe JOIN cider_hash_join_table_hash ON l_b = r_b OR l_b = 10 ;
-- SELECT SUM(l_a) from cider_hash_join_table_probe LEFT JOIN cider_hash_join_table_hash ON l_a = r_a OR l_a = 10 ;
...
-- SELECT SUM(r_a) from cider_hash_join_table_probe LEFT JOIN cider_hash_join_table_hash ON l_a = r_a OR l_d = r_d ;
SELECT SUM(r_a) from cider_hash_join_table_probe JOIN cider_hash_join_table_hash ON l_b = r_b OR l_b = 10 ;
-- SELECT SUM(r_a) from cider_hash_join_table_probe LEFT JOIN cider_hash_join_table_hash ON l_a = r_a OR l_a = 10 ;
