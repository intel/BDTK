...
SELECT col_a FROM date_type_query_test_1 where col_b < cast(date '1970-01-01' + interval '1' year as varchar);
SELECT col_a FROM date_type_query_test_1 where col_b < cast(date '1970-01-01' + interval '2' year as varchar);
SELECT col_a FROM date_type_query_test_1 where col_b < cast(date '1970-01-01' + interval '1' month as varchar);
SELECT col_a FROM date_type_query_test_1 where col_b < cast(date '1970-01-01' + interval '10' month as varchar);
SELECT col_a FROM date_type_query_test_1 where col_b > cast(date '1971-01-01' - interval '1' year as varchar);
SELECT col_a FROM date_type_query_test_1 where col_b > cast(date '1971-01-01' - interval '12' month as varchar);
SELECT col_a FROM date_type_query_test_1 where col_b >= cast(date '1970-01-01' + interval '1' month as varchar) and col_b < cast(date '1970-01-01' + interval '2' month as varchar);
SELECT col_a FROM date_type_query_test_1 where col_b < cast(date '1970-01-01' + interval '1' day as varchar);
SELECT col_a FROM date_type_query_test_1 where col_b < cast(date '1970-01-01' + interval '80' day as varchar);
SELECT col_a FROM date_type_query_test_1 where col_b > cast(date '1970-02-01' - interval '10' day as varchar);
