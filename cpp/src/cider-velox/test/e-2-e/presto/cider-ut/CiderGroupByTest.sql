...
SELECT col_a, col_b, col_c, SUM(col_a), SUM(col_b), SUM(col_c) FROM cider_group_by_test_2 GROUP BY col_a, col_b, col_c HAVING col_a > 5 and col_b < 5;
-- SELECT SUM(col_a) AS col_a_sum, SUM(col_b) AS col_b_sum FROM cider_group_by_test_2 GROUP BY col_a, col_b HAVING col_a <> col_b AND col_a IS NOT NULL;
...
-- SELECT col_a, col_b, col_c, SUM(col_a), SUM(col_b), SUM(col_c) FROM cider_group_by_test_2 WHERE col_a > 5 GROUP BY col_a, col_b, col_c;
